  ...
  return (
    ...
    >
      ...
      <div className="d-flex gap-2" id="nav-button">
        <button className="hiring-btn" style={{ width: '120px', padding: '.5rem', background: '#f6f6f4', color: 'black', border: 'none' }}>
          We're hiring
        </button>
        <button style={{ width: '120px', padding: '.5rem', background: '#f85c1d', color: 'white', border: 'none' }}>
          Get Started
        </button>
      </div>
    </Navbar>
